...
def main():
    parser = argparse.ArgumentParser(description="Генерация сказки с помощью обученной модели.")
    parser.add_argument("--title", type=str, default="The Dragon and the Little Mouse", help="Название сказки")
    parser.add_argument("--start", type=str, default="", help="Начальная фраза для генерации (опционально)")
    parser.add_argument("--max_tokens", type=int, default=200, help="Сколько токенов сгенерировать")
